...
const Paintball = () => {
  return (
    ...
    <Head>
        <title>Royal Ridges&#39; Paintball Facilities and Programs</title>
      </Head>
      <Header />
      <div className='max-w-6xl mx-2 md:mx-auto text-xs md:text-base h-screen overflow-y-scroll'>
        <Image
          src='https://royal-ridges-retreat.s3.us-west-1.amazonaws.com/programs-page/headerPhotos/paintball.png'
          alt='paintball'
          width={400}
          height={400}
        ...
        <p className='mt-2'>
          Royal Ridges is committed to offering you the safest
          possible family-friendly environment for you to immerse
          yourself in the adventure of woods ball, scenario paintball,
          or tournament style speed-ball. There are 2 large speed-ball
          fields, a 20 acre woods-ball field, and a Tactical Village.
          Book your next extreme adventure with us! All charges cover
          the cost of a mask, a marker, paint balls, and an hour or
          two of game play.
        </p>
        <p className='mt-2'>
        ...
        <p className='mt-2'>
          There is a $45 charge per additional person over five (5)
          players. For example, seven (7) players total would be $225
          + $45 + $45 = $315
        </p>
        ...
        <p className='flex flex-wrap justify-center text-xl md:text-4xl font-cursive text-gray-600'>
        ...
        <div className='py-20 text-center text-2xl'>
          <p className='my-2'>
            Paintball Liability Form{` `}
            <a
              href='https://waiver.smartwaiver.com/w/54c2a108cb5e3/web/'
              className='text-green-200 hover:underline hover:text-indigo-400'
              target='_blank'
              rel='noopener noreferrer'
            >
