  ...
  return (
    <div className='bg-gradient-to-l from-pink-200 to-indigo-200'>
      ...
      <div className='h-screen max-w-6xl mx-auto text-gray-800'>
        <p className='text-xl'>
          This form is required for all summer camps. We suggest you
          complete the form at the time of your purchase. Forms are
          valid from October 1 to September 30. You only need to
          complete the forms once a year unless your information needs
          to be updated or changed. Please complete forms when you
          register for camp.
        </p>
        ...
        <div className='text-center'>
          <p className='text-red-400 font-semibold text-xl pt-10'>
            Campers will not participate in any activities if the
            waiver is not completed prior to camp starting.
          </p>
