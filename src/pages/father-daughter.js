...
const FatherDaughter = () => {
  return (
    <div className='bg-gradient-to-r from-yellow-200 to-indigo-200'>
      <Head>
        <title>Father Daughter Programs @ Royal Ridges</title>
      </Head>
      <Header />
      <div className='h-screen'>
        ...
        <div className='max-w-6xl h-1/2 mx-auto grid grid-cols-2 gap-4'>
          {/*Column One (Left)*/}
          <div className='flex flex-col justify-between justify-items-center mt-2'>
          ...
          <div className='flex flex-col justify-start mt-2'>
            <p>
              This special day is set aside for fathers and their
              daughters, 8 years and older, to spend time together and
              build their relationship with each other.
            </p>
            <p>
