...
export const metadata = {
  title: 'Terms of Service @ Royal Ridges',
  description:
    'Royal Ridges Retreat in Southern Washington Terms of Service',
};
  ...
  return (
    <div className='bg-gradient-to-l from-yellow-200 to-green-200'>
      ...
      <div className='max-w-6xl mx-auto'>
        <p>
          BY VISITING OUR WEBSITE, YOU ARE ACCEPTING OUR TERMS OF
          SERVICE. Overview This website is operated by Royal Ridges
          Camps. Throughout the site, the terms “we”, “us” and “our”
          refer to Royal Ridges Camps. Royal Ridges Camps offers this
        ...
        <p>
          SECTION 1 - GENERAL CONDITIONS We reserve the right to
          refuse service to anyone for any reason at any time. You
          ...
          service is provided, without express written permission by
          us. The headings used in this agreement are included for
          convenience only and will not limit or otherwise affect
          these Terms.
        </p>
        <p>
          SECTION 2 - ACCURACY, COMPLETENESS AND TIMELINESS OF
          INFORMATION We are not responsible if information made
          ...
          primary, more accurate, more complete or more timely sources
          of information. Any reliance on the material on this site is
          at your own risk. This site may contain certain historical
        ...
        <p>
          SECTION 3 - MODIFICATIONS TO THE SERVICE AND PRICES Prices
          for our products are subject to change without notice. We
          reserve the right at any time to modify or discontinue the
          Service (or any part or content thereof) without notice at
          any time. We shall not be liable to you or to any
          third-party for any modification, price change, suspension
          or discontinuance of the Service.
        </p>
        <p>
          SECTION 4 - PRODUCTS OR SERVICES (if applicable) Certain
          products or services may be available exclusively online
          through the website. These products or services may have
          limited quantities and are subject to return or exchange
          only according to our Return Policy. We have made every
          effort to display as accurately as possible the colors and
          images of our products that appear at the store. We cannot
        ...
        <p>
          SECTION 5 - ACCURACY OF BILLING AND ACCOUNT INFORMATION We
          reserve the right to refuse any order you place with us. We
        ...
        <p>
          ...
          third-party tools. Any use by you of optional tools offered
          through the site is entirely at your own risk and discretion
          and you should ensure that you are familiar with and approve
          of the terms on which tools are provided by the relevant
          third-party provider(s). We may also, in the future, offer
          new services and/or features through the website (including,
          the release of new tools and resources). Such new features
          and/or services shall also be subject to these Terms of
          Service.
        </p>
        <p>
          SECTION 7 - THIRD-PARTY LINKS Certain content, products and
          services available via our Service may include materials
          from third-parties. Third-party links on this site may
          direct you to third-party websites that are not affiliated
          with us. We are not responsible for examining or evaluating
          the content or accuracy and we do not warrant and will not
          have any liability or responsibility for any third-party
          materials or websites, or for any other materials, products,
          or services of third-parties. We are not liable for any harm
          or damages related to the purchase or use of goods,
          services, resources, content, or any other transactions made
        ...
        <p>
          SECTION 8 - PERSONAL INFORMATION Your submission of personal
          information through the store is governed by our{' '}
          <Link
            href={'/privacy'}
        ...
        <p>
          SECTION 9 - ERRORS, INACCURACIES AND OMISSIONS Occasionally
        ...
        <p>
          SECTION 10 - PROHIBITED USES In addition to other
        ...
        <p>
          ...
          LIABILITY We do not guarantee, represent or warrant that
          your use of our service will be uninterrupted, timely,
          secure or error-free. We do not warrant that the results
          that may be obtained from the use of the service will be
          accurate or reliable. You agree that from time to time we
          may remove the service for indefinite periods of time or
          cancel the service at any time, without notice to you. You
          ...
          (except as expressly stated by us) provided &#39;as is&#39;
          ...
          non-infringement. In no case shall Royal Ridges Camps, our
        ...
        <p>
          SECTION 12 - INDEMNIFICATION You agree to indemnify, defend
          and hold harmless Royal Ridges Camps and our parent,
        ...
        <p>
          SECTION 13 - SEVERABILITY In the event that any provision of
        ...
        <p>
          SECTION 14 - TERMINATION The obligations and liabilities of
          the parties incurred prior to the termination date shall
        ...
        <p>
          SECTION 15 - ENTIRE AGREEMENT The failure of us to exercise
          or enforce any right or provision of these Terms of Service
        ...
        <p>
          SECTION 16 - CHANGES TO TERMS OF SERVICE You can review the
          most current version of the Terms of Service at any time at
          this page. We reserve the right, at our sole discretion, to
        ...
        <p>
          SECTION 17 - CONTACT INFORMATION If you have questions about
          the Terms of Service please email us at{' '}
          <a
